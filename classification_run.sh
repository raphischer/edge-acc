...
do
    for b in  'NCS2' 'tflite_edgetpu'
    do
    echo $n $b
    python3 pycoral_classification.py -b $b  -mn $n -ic 12000 -md  /home/staay/Git/imagenet-on-the-edge/mnt_data/staay/eval12000_batchsize_64
    done
done
