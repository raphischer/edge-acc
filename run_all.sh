...
do
    ...
    do
    echo $n $b
    python3 pycoral_classification.py -b $b  -mn $n -ic 320 -md  /home/staay/Git/imagenet-on-the-edge/mnt_data/staay/workstation_final_15_12_2023
    done
done
...
for n in 'EfficientNetB1','EfficientNetB2','EfficientNetB3','EfficientNetV2S','EfficientNetV2M'
do
    for b in  'tf_cpu'
    do
    echo $n $b
